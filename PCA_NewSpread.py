...
# Apply standardization to each day's data and calculate the new crack spread
pivot_data['new_crack_spread'] = price_data.apply(standardize_data, axis=1).dot(pc2_vector)
